...
export const post: BlogPost = {
  "id": "blog-post-server-authoritative-netcode",
  ...
  "metaTitle": "Preventing Cheats in Online Games | Blog Hub",
  "metaDescription": "Client-side rolls are easily hacked. Explore how we implemented server-side roll generation and turn validation in FastAPI, and why it forms the backbone o",
  ...
  "keywords": [
    ...
    "game lobby security fastapi",
    "preventing browser game cheats",
  ...
  "sections": [
    {
      ...
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Preventing Cheats in Online Games remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Preventing Cheats in Online Games truly random?",
