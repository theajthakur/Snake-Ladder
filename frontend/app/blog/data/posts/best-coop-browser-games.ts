...
export const post: BlogPost = {
  "id": "blog-post-best-coop-browser-games",
  "slug": "best-coop-browser-games",
  "title": "Best Collaborative Co-Op Browser Games to Play with Coworkers",
  "metaTitle": "Best Collaborative Co-Op Browser Games to Play with Coworkers | Blog Hub",
  "metaDescription": "Need a team-building break? Here is a list of excellent cooperative browser games that encourage collaboration, communication, and friendly competition rig",
  ...
  "keywords": [
    "coop browser games",
    "collaborative games for work",
    "virtual team building games",
    "multiplayer cooperative browser"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Best Collaborative Co-Op Browser Games to Play with Coworkers remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Best Collaborative Co-Op Browser Games to Play with Coworkers truly random?",
