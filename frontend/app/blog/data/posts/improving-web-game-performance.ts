...
export const post: BlogPost = {
  "id": "blog-post-improving-web-game-performance",
  "slug": "improving-web-game-performance",
  "title": "Core Web Vitals for HTML5 Games: How to Achieve 100 Lighthouse Performance",
  "metaTitle": "Core Web Vitals for HTML5 Games | Blog Hub",
  "metaDescription": "Struggling with slow loading screens and laggy animations? Learn how image decoding, font subsets, CSS variables, and layout optimizations can push your Li",
  ...
  "keywords": [
    "core web vitals games",
    "optimizing html5 game load",
    "lighthouse score 100 nextjs",
    "reducing layout shifts canvas"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Core Web Vitals for HTML5 Games remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Core Web Vitals for HTML5 Games truly random?",
