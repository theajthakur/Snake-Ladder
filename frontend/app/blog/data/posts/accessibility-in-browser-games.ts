...
export const post: BlogPost = {
  "id": "blog-post-accessibility-in-browser-games",
  "slug": "accessibility-in-browser-games",
  "title": "Web Accessibility (A11y) in HTML5 Gaming: Guidelines for Developers",
  "metaTitle": "Web Accessibility (A11y) in HTML5 Gaming | Blog Hub",
  "metaDescription": "Games should be playable by everyone. A review of accessibility best practices for web games, including aria-labels, high-contrast paths, keyboard inputs, ",
  ...
  "keywords": [
    "accessibility in browser games",
    "a11y game design standards",
    "keyboard controls game canvas",
    "inclusive game UI design"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Web Accessibility (A11y) in HTML5 Gaming remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Web Accessibility (A11y) in HTML5 Gaming truly random?",
