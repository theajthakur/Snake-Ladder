...
export const post: BlogPost = {
  "id": "blog-post-future-of-webassembly-in-gaming",
  "slug": "future-of-webassembly-in-gaming",
  "title": "WebAssembly and WebGL: The Next Frontier for Browser-Based Board Games",
  "metaTitle": "WebAssembly and WebGL | Blog Hub",
  "metaDescription": "HTML5 is just the start. Discover how WebGL shaders and WebAssembly (Wasm) pipelines are pushing the performance boundaries of browser board games toward d",
  ...
  "keywords": [
    "future of webassembly gaming",
    "webgl browser board games",
    "wasm canvas rendering speed",
    "next gen html5 games"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like WebAssembly and WebGL remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on WebAssembly and WebGL truly random?",
