...
export const post: BlogPost = {
  "id": "blog-post-psychology-of-board-game-wins",
  "slug": "psychology-of-board-game-wins",
  "title": "The Thrill of the Roll: Understanding the Psychology Behind Turn-Based Games",
  "metaTitle": "The Thrill of the Roll | Blog Hub",
  "metaDescription": "Why are dice games so addictive? We unpack the dopamine triggers, the anticipation of rolling, and the psychological impact of climbing ladders and falling",
  ...
  "keywords": [
    "psychology of gaming wins",
    "why dice rolling is exciting",
    "dopamine triggers in board games",
    "turn based game anticipation"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like The Thrill of the Roll remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on The Thrill of the Roll truly random?",
