...
export const post: BlogPost = {
  ...
  "metaTitle": "The Digital Transformation | Blog Hub",
  "metaDescription": "Analyzing the massive resurgence of classic board games in digital formats. Why multiplayer browser games are experiencing a renaissance and how modern web",
  ...
  "sections": [
    {
      ...
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like The Digital Transformation remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on The Digital Transformation truly random?",
