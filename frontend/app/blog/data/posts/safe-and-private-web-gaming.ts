...
export const post: BlogPost = {
  "id": "blog-post-safe-and-private-web-gaming",
  "slug": "safe-and-private-web-gaming",
  "title": "Playing It Safe: Why We Don't Require Accounts for Multiplayer Gaming",
  "metaTitle": "Playing It Safe | Blog Hub",
  "metaDescription": "Accounts introduce passwords, data storage liabilities, and friction. We discuss the benefits of building lobby environments using temporary UUID identifie",
  ...
  "keywords": [
    "private multiplayer gaming online",
    "no account registration games",
    "secure browser lobby connections",
    "temporary player session management"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Playing It Safe remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Playing It Safe truly random?",
