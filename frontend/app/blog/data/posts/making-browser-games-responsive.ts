...
export const post: BlogPost = {
  "id": "blog-post-making-browser-games-responsive",
  "slug": "making-browser-games-responsive",
  "title": "Behind the Scenes: How We Built a Fully Scalable Board Game Canvas",
  "metaTitle": "Behind the Scenes | Blog Hub",
  "metaDescription": "Creating a game board that fits perfectly on both an iPhone and an ultrawide monitor is a challenge. Learn how we used ResizeObservers, absolute coordinate",
  ...
  "sections": [
    {
      ...
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Behind the Scenes remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Behind the Scenes truly random?",
