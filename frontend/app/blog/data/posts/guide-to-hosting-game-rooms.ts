...
export const post: BlogPost = {
  "id": "blog-post-guide-to-hosting-game-rooms",
  "slug": "guide-to-hosting-game-rooms",
  "title": "Step-by-Step Guide to Hosting Online Private Rooms on Vercel",
  "metaTitle": "Step-by-Step Guide to Hosting Online Private Rooms on Vercel | Blog Hub",
  "metaDescription": "Want to set up your own lobby server? We walk you through deploying a Next.js front-end and a Python FastAPI back-end to Vercel, and configuring secure COR",
  ...
  "keywords": [
    "hosting multiplayer rooms vercel",
    "deploy fastapi vercel",
    "nextjs deployment backend",
    "configuring cors game server"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Step-by-Step Guide to Hosting Online Private Rooms on Vercel remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Step-by-Step Guide to Hosting Online Private Rooms on Vercel truly random?",
