...
export const post: BlogPost = {
  "id": "blog-post-revisiting-ludo-and-snakes-ladders",
  "slug": "revisiting-ludo-and-snakes-ladders",
  "title": "Revisiting Childhood Classics: Ludo, Snakes & Ladders, and Backgammon",
  "metaTitle": "Revisiting Childhood Classics | Blog Hub",
  "metaDescription": "Take a trip down memory lane. We examine the shared history and structural similarities of Ludo, Backgammon, and Snakes and Ladders, and why they remain po",
  ...
  "keywords": [
    ...
    "history of ludo backgammon",
    "classic board games list",
    "old fashioned dice games"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Revisiting Childhood Classics remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Revisiting Childhood Classics truly random?",
