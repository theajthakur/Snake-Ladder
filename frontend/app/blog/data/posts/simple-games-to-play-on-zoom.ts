...
export const post: BlogPost = {
  "id": "blog-post-simple-games-to-play-on-zoom",
  "slug": "simple-games-to-play-on-zoom",
  "title": "Quick and Fun Web Games to Play During Your Next Zoom Call",
  "metaTitle": "Quick and Fun Web Games to Play During Your Next Zoom Call | Blog Hub",
  "metaDescription": "Bored in virtual meetings? Here are the best low-friction, instant-loading web games you can easily play with friends or team members during standard video",
  ...
  "keywords": [
    "simple games to play on zoom",
    "instant browser games virtual meetings",
    "fun remote team building games",
    "quick multiplayer web games"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Quick and Fun Web Games to Play During Your Next Zoom Call remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Quick and Fun Web Games to Play During Your Next Zoom Call truly random?",
