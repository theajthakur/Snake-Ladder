...
export const post: BlogPost = {
  "id": "blog-post-two-player-games-online",
  "slug": "two-player-games-online",
  "title": "Top Two-Player Online Games to Play Remotely with Friends",
  "metaTitle": "Top Two-Player Online Games to Play Remotely with Friends | Blog Hub",
  "metaDescription": "Looking for a quick game with a friend? Explore the best free two-player online games that require no account sign-up and offer instant real-time multiplay",
  ...
  "keywords": [
    ...
    "play with friends",
    "browser multiplayer",
    "casual two player games"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Top Two-Player Online Games to Play Remotely with Friends remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Top Two-Player Online Games to Play Remotely with Friends truly random?",
