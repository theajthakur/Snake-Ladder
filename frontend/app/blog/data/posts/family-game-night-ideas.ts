...
export const post: BlogPost = {
  "id": "blog-post-family-game-night-ideas",
  "slug": "family-game-night-ideas",
  "title": "How to Host the Perfect Virtual Family Game Night",
  "metaTitle": "How to Host the Perfect Virtual Family Game Night | Blog Hub",
  "metaDescription": "Keep the family connected across distances. A complete step-by-step guide to hosting a virtual board game night, including screen sharing tips, multiplayer",
  ...
  "keywords": [
    ...
    "family board games online",
    "how to host zoom games",
    "social board gaming"
  ],
  "sections": [
    {
      ...
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like How to Host the Perfect Virtual Family Game Night remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on How to Host the Perfect Virtual Family Game Night truly random?",
