...
export const post: BlogPost = {
  "id": "blog-post-traditional-vs-modern-board-games",
  "slug": "traditional-vs-modern-board-games",
  "title": "Classic vs. Modern Board Games: What Keeps Us Rolling the Dice?",
  "metaTitle": "Classic vs. Modern Board Games | Blog Hub",
  "metaDescription": "Why do simple games like Snakes & Ladders, Ludo, and Monopoly remain global favorites in a world dominated by complex video game releases? A deep cultural ",
  ...
  "keywords": [
    "traditional vs modern board games",
    "why board games remain popular",
    "board games cultural impact",
    "timeless dice game design"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Classic vs. Modern Board Games remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Classic vs. Modern Board Games truly random?",
