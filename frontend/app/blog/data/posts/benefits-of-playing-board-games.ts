...
export const post: BlogPost = {
  "id": "blog-post-benefits-of-playing-board-games",
  "slug": "benefits-of-playing-board-games",
  "title": "Cognitive Benefits of Playing Classic Board Games for All Ages",
  "metaTitle": "Cognitive Benefits of Playing Classic Board Games for All Ages | Blog Hub",
  "metaDescription": "Board games are not just for fun. Discover how rolling dice, tracking movements, and counting cells can improve mathematical thinking, spatial awareness, a",
  ...
  "sections": [
    {
      ...
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Cognitive Benefits of Playing Classic Board Games for All Ages remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Cognitive Benefits of Playing Classic Board Games for All Ages truly random?",
