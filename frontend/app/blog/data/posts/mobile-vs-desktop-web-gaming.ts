...
export const post: BlogPost = {
  "id": "blog-post-mobile-vs-desktop-web-gaming",
  "slug": "mobile-vs-desktop-web-gaming",
  "title": "Optimizing Touch vs. Click: Designing Cross-Platform Web Game Layouts",
  "metaTitle": "Optimizing Touch vs. Click | Blog Hub",
  "metaDescription": "Handling cursor hover prediction maps on desktop while keeping elements reachable and scroll-locked on touch screens. Learn our UX guidelines for robust cr",
  ...
  "keywords": [
    "mobile vs desktop web gaming",
    "optimizing touch controls react",
    "cross platform game layouts",
    "preventing mobile zoom canvas"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like Optimizing Touch vs. Click remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on Optimizing Touch vs. Click truly random?",
