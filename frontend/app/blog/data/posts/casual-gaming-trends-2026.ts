...
export const post: BlogPost = {
  "id": "blog-post-casual-gaming-trends-2026",
  "slug": "casual-gaming-trends-2026",
  "title": "The Rise of Micro-Gaming: Why Casual Web Games Are More Popular Than Ever",
  "metaTitle": "The Rise of Micro-Gaming | Blog Hub",
  "metaDescription": "Short sessions, high engagement, and zero friction. We break down why players in 2026 prefer fast browser-based casual matches over large, heavy game insta",
  ...
  "keywords": [
    "casual gaming trends 2026",
    "browser games popularity",
    "micro gaming shift",
    "free web games popularity"
  ],
  "sections": [
    {
      "heading": "Introduction",
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like The Rise of Micro-Gaming remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on The Rise of Micro-Gaming truly random?",
