...
export const post: BlogPost = {
  "id": "blog-post-evolution-of-dice-games",
  "slug": "evolution-of-dice-games",
  "title": "From Knucklebones to Digital Simulators: The Complete Evolution of Dice Games",
  "metaTitle": "From Knucklebones to Digital Simulators | Blog Hub",
  "metaDescription": "Dice have been rolled for over 5,000 years. Trace the evolution of dice games from ancient Egyptian knucklebones to server-side cryptographic random genera",
  ...
  "sections": [
    {
      ...
      "paragraphs": [
        "In the rapidly evolving landscape of digital media and gaming, traditional formats often get left behind in favor of high-fidelity console graphics and complex role-playing structures. However, classic board games like From Knucklebones to Digital Simulators remain a cornerstone of family entertainment. Our team set out to examine this phenomenon: what is it about dice rolling, turn sequences, and classic boards that keeps pulling players back?",
  ...
  "faqs": [
    {
      "question": "Is the dice generation on From Knucklebones to Digital Simulators truly random?",
