...
/**
 * app/play/page.tsx — Game board + dice + animation
 *
...
export default function PlayPage() {
  ...
  // ── Roll handler ──────────────────────────────────────────────────────────
  const handleRoll = useCallback(async (dice: number) => {
  ...
  // Biased roll for locked players (P(6) = 1/3)
  const getFinalValue = isLocked
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 14,
              border:      'none',
              background:  'linear-gradient(135deg, #6c3fff, #b83fff)',
              boxShadow:   '0 6px 24px rgba(108,63,255,0.5)',
              color:       '#fff',
              fontSize:    '1rem',
              fontWeight:   800,
              cursor:      'pointer',
